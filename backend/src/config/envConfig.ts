...
export const DRIVE_CREDENTIALS_FILE =
  process.env.DRIVE_CREDENTIALS_FILE || "credentials.json";
export const DRIVE_PARENT_FOLDER_ID = process.env.DRIVE_PARENT_FOLDER_ID || "";
export const DRIVE_FOLDER_NAME = process.env.DRIVE_FOLDER_NAME || "BoardVault";
